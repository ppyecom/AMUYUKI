  ...
  return (
    <div className="create-home">
      <div className="header-create">
        ...
        <p>Diseña un personaje único que refleje tu historia, tu estilo y tu imaginación</p>
      </div>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="card-content">
                <div className="icon"><img src={feature.icon} alt={feature.title} /></div>
                <div className="text">
                  <h3 className="title">{feature.title}</h3>
                  {feature.description && <p className="description">{feature.description}</p>}
                </div>
                {feature.buttonText && (
                  <button className="action-button">{feature.buttonText}</button>
                )}
              </div>
            </div>
          ))}
